...
<div>
  ...
  <div class="tw-border tw-border-obsidian tw-rounded-md">
    <input
      ...
      id="" name=""
      wire:model.live="shareLink"
      value="{{ $shareLink }}"
      placeholder="Masukkan link shareable gdrive"
      autocomplete="off"
    >
  </div>
  <div class="tw-mb-2">
    ...
    <span class="tw-text-sm tw-block">
      Konten merupakan gambar dengan ekstensi .png, .jpg, .jpeg
    </span>
  </div>
  <div class="">
    ...
    <div class="tw-flex tw-mb-2">
      ...
      <div class="tw-border tw-border-obsidian tw-px-3 tw-rounded-r-md tw-w-full tw-flex tw-items-center">
        <span id="paste" wire:model="contentLink">{{ $contentLink }}</span>
      </div>
    </div>
  </div>
</div>
